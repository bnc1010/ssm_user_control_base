...
INSERT INTO `user` VALUES (2,'Tom','5566','1990-12-25',1,18),(3,'bnc','e10adc3949ba59abbe56e057f20f883e',NULL,NULL,NULL),(4,'test','e10adc3949ba59abbe56e057f20f883e',NULL,NULL,10),(9,'ccc','e10adc3949ba59abbe56e057f20f883e',NULL,NULL,NULL);
...
INSERT INTO `user_role` VALUES (3,1),(3,6),(4,2),(9,3),(9,6);
...
INSERT INTO `role_permission` VALUES (1,1),(1,6),(2,1),(2,2),(3,1),(3,2),(3,6),(4,1),(4,2),(4,3);
...
INSERT INTO `role` VALUES (1,'系统管理员','a'),(2,'用户管理员','a'),(3,'普通用户','g'),(5,'testRole','g'),(6,'testRole2','a');
...
INSERT INTO `permission` VALUES (1,'(/apis/system/.*|/apis/system)','系统管理','p'),(2,'(/apis/users/.*|/apis/users)','用户管理','p'),(3,'/apis/helper/checkAdmin','管理界面','p'),(4,'/apis/home/.*','登录登出注册','p');
...
-- Dump completed on 2019-12-05 21:40:16
